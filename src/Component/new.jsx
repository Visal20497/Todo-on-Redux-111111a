...
// function New() {
//   let [totalPercentShare, setTotalPercentShare] = useState(0);
//   let sectionData = useState(0);
// useEffect(() => {
//     let totalPercentShareData = 0;
//     sectionData &&
//       sectionData.length &&  
...
//         ) {
//           totalPercentShareData = parseInt(
//             item.initial_collateral.collateral_details.percent_share
//           );
//         }
//       });
//     if (totalPercentShareData <= 100) {
//       setTotalPercentShare(totalPercentShareData);
//     }
//     else{
//         alert("total share addition should not more than 100%")
//     }
//   }, [sectionData]);
//   return <div>new</div>;
// }
...
// 	const [totalPercentShare, setTotalPercentShare] = useState(0);
...
// 						parseInt(item.initial_collateral.collateral_details.percent_share)
// 					);
// 				}
// 			});
